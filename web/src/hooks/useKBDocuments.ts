...
const DOC_LIST_COLUMNS = 'id, filename, title, file_type, file_size, status, path, tags, date, metadata, error_message, version, document_number, sort_order, parser, archived, created_at, updated_at, knowledge_base_id, user_id, url, page_count'
